...
| **dext-examples** | `dext-examples.md` | Index of official `Examples\` projects, compile commands, which demo shows which feature |
...
**Load `dext-examples`** when:

- Finding which project under `Examples\` demonstrates a pattern or feature
- Needing MSBuild compile commands or the curated business vs utility demo list
