...
{                                                                           }
{  Uses / composition root (Dext convention):                             }
{    In Startup, list Dext, Dext.Entity, Dext.Web last and in that order.   }
{    Event Bus registration lives in EventBusWebDemo.EventBusConfig because }
{    TWebServicesHelper (Dext.Web) and TEventBusDIExtensions              }
{    (Dext.Events.Extensions) cannot both apply to TDextServices in the     }
{    same unit — the config unit uses only Dext.Events.Extensions.          }
{***************************************************************************}
